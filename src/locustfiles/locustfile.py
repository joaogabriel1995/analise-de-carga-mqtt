...
from config.config import BROKER_HOST, BROKER_PORT, MQTT_USERNAME, MQTT_PASSWORD, SIZE_PAYLOAD, SIMULATION_NAME,NUM_REQUESTS
...
class MQTTLocustUser(User):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.mqtt = MQTTClientManager(str(BROKER_HOST), int(BROKER_PORT), str(MQTT_USERNAME), str(MQTT_PASSWORD), False)
